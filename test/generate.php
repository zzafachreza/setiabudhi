...
<div class="row">
  <div class="col col-sm-12">
     ...
     <blockquote class="blockquote" style="margin-top: 5%">
        <center>
          <h2>GENERATE CODE (MODEL, VIEW, CONTROLLER)</h2>
  ...
  <div class="col col-sm-12">
    <form id="dataGenerate" method="post" action="coding.php"  >
      
    <table class="table">
    	<tr>
    		<td>Nama Table</td>
    		<td><input type="tex" name="table" class="form-control" placeholder="masukan nama tabel"></td>
    	</tr>
    	<tr>
    		<td>Jumlah Kolom</td>
    		<td><input type="number" id="kolom" name="kolom" class="form-control" placeholder="masukan jumlah kolom"></td>
    	</tr>
   ...
   <center>
        <blockquote class="blockquote text-center" style="margin-top: 5%">
          <footer class="blockquote-footer" style="color:#000">
           ERP marketing terbaik yang bisa monitoring, integrasi hanya dengan satu sistem       </footer>
        <p class="mb-0"></p>
        <p id="eza" style="color: #0d6efd">By Fachreza Maulana</p>
      </blockquote>
  </center>
  </div>
</div>
...
<script>
	...
	$("#kolom").change(function(){
		...
		for ($i=0;$i<kolom;$i++) {
			...
			$("#dataKolom").append('<input name="row[]" class="form-control" style="margin-bottom:1%"/>')
		}
