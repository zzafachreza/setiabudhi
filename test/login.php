...
<div class="row">
  <div class="col col-sm-12" style="padding: 5%;padding-left: 15%;padding-top: 2%;">
    ...
    <div class="col col-sm-6">
        <img src="login.svg" style="width:100%" />
        </div>
  <div class="col col-sm-6">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <button class="btn btn-secondary col-sm-12" onclick="window.location.href='./register'">Register</button>
      </div>
  ...
  <div class="col-sm-12">
   <center>
        ...
        <p class="mb-0"></p>
        <footer class="blockquote-footer" style="color: #000">By Promedik</footer>
      </blockquote>
  </center>
  </div>
</div>
