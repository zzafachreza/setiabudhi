...
<div class="container">
	<hr/>
	<form method="POST" action="./cndn/download">
		<div class="row">
			<div class="col col-sm-6">
				<h2>Tarik CNDN Account Payable</h2>
				<img src="./assets/images/ap.svg" width="250">
			</div>
			<div class="col col-sm-6" style="margin-bottom: 10%">

				<div class="from-group">
					<label>Please Select Type</label>
					<select class="form-control selectza" name="CNDNtype">
						<option></option>
						<?php
							$sqlData ="SELECT CNDNTypeCode,CNDNTypeName FROM  APCNDNType";
						...
						?>
							...
							<option value="<?php echo $r['CNDNTypeCode'] ?>"><?php echo $r['CNDNTypeCode'] ?> - <?php echo $r['CNDNTypeName'] ?></option>
						<?php
							}
						?>
					</select>
