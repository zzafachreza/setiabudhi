...
if(!empty($_POST)){
      ...
      $sql="select TransNmbr,convert(varchar,TransDate,103) TransDate,TransCustId,cusname,TransDesc,TransHCAmount 
from dbo.SATrans inner join SMCusMs 
on SATrans.TransCustId = SMCusMs.cusid
            ...
            <table width="100%" border="1">
                ...
                <tbody>
                      ...
                      <tr style="background-color:#bdc3c7">
                          ...
                          <td class="text"><?php echo $row['TransCustId'] ?></td>
                          <td class="text"><?php echo $row['cusname'] ?></td>
                              ...
                              ?>
                               <td style="background-color: #C4E538">
                                <?php 
                                     ...
                                     $sql="select SettleCustid, convert(float,sum(TransHCAmount)) total 
from (dbo.SASettlementHd inner join SMCusMs on SASettlementHd.SettleCustid = SMCusMs.cusid)
 inner join SASettlementDt on SASettlementHd.SettleNmbr = SASettlementDt.SettleNmbr  
                                          WHERE SATransNmbr='$ID' and Month(SettleDate)='$MM' and Year(SettleDate)='$YY' GROUP BY SettleCustid";
