...
header("Content-Disposition: attachment; filename=BR ".$_GET['br']."_".date('d/m/Y').".xls");//ganti nama sesuai keperluan
...
$GROUP_PO = $_GET['br'];
 ...
 $sqlTest="UPDATE data_antrian SET OKE='1' WHERE GROUP_PO='$GROUP_PO' AND STATUS_ANTRIAN='FINISH'";

$test = $conn->query($sqlTest);

if ($test) {

	$sql="SELECT * FROM data_antrian WHERE GROUP_PO='$GROUP_PO' AND OKE=1 AND TANGGAL_SELESAI='$NOW'";
